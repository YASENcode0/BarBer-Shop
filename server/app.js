...
app.post("/addturnuser", async (req, res) => {
  try {
    const { _id, id } = req.body;
    const freeTurn = await turn.findOne({ _id });
    console.log(freeTurn);

    freeTurn.isFree = true;
    freeTurn.user = id;
...
app.post("/cancelturn", async (req, res) => {
  try {
    const { _id } = req.body;
    const findTurn = await turn.findOne({ _id });
    console.log(findTurn);

    findTurn.isFree = false;
    findTurn.user = null;
